...
The project assumes you're running a database named ```tripiq``` on ```127.0.01```, or you can create a new MySQL database and update the server/db.js file with your database information.
